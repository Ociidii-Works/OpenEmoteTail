...
default
{
    ...
    listen(integer c, string n, key i, string m)
    {
       ...
       debug(touchername+" selected "+m2);
        ...
        {
            debug("Something unexpected happened");
        }
    }
    timer()
    {
...
//program_version Phoenix Firestorm-Release v4.3.1.31155 - Miguael Liamano
//mono
...
//#line 14 "C:\\Program Files (x86)\\Firestorm-Release\\:[Za]: Bunny Emote Tail \\\\ v2.2"
list list_cute = ["Brush","Carress","Grab","Hug","Play","Stroke","Squeak","Yank"];
list list_adult = ["Fluff","Grope","Hump","Butt Lick","Hot Lick","Smack"];
list choice = ["Cute","Adult"];
